...
def coin_positions(*args):
	...
	if first_strike:
		...
		# pocket4_async = pool.apply_async(coin_positions4, (args))
		# pocket2_async = pool.apply_async(coin_positions2, (args))

		# pocket4_results = pocket4_async.get()
		# pocket2_results = pocket2_async.get()

		# print 'pocket4_async.get(): ', pocket4_results, '\n'
		# print 'pocket2_async.get(): ', pocket2_results, '\n'
		# t1 = threading.Thread(target=coin_positions4, args=(args))
		# t2 = threading.Thread(target=coin_positions2, args=(args))
		# t1.start()
		# t2.start()
		# t1.join()
		# t2.join()
		...
		q = mp.Queue()
		job1 = mp.Process(target=coin_positions4, args=(args, return_dict))
		job2 = mp.Process(target=coin_positions2, args=(args, return_dict))
		job1.start()
		job2.start()
		job1.join()
		job2.join()
